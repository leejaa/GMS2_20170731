...
<table id="index-tab" style="margin-left: 130px;margin-top: 50px; border-color: red; border-style: solid;">
	...
	<tr id="index-tab-tr">
		<td>
			<ul class="index-ul">
				<li><a href="<%=request.getContextPath()%>/member.do?action=move&page=join">회원가입</a></li>
				<li><a href="<%=request.getContextPath()%>/member.do?action=move&page=list">회원목록</a></li>
				<li><a href="<%=request.getContextPath()%>/member.do?action=move&page=update">회원정보수정</a></li>
				<li><a href="<%=request.getContextPath()%>/member.do?action=move&page=delete">회원탈퇴</a></li>
			</ul>
		</td>
		<td>
			<ul class="index-ul">
