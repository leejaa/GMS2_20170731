...
<jsp:include page="/WEB-INF/view/common/common_head.jsp" />
 <div class="container">    
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-xs-12 col-sm-6 col-lg-9">
                    <div class="" style="border-bottom:1px solid black">
                      <h2>${requestScope.student.name} 님의 프로필</h2>&nbsp;&nbsp;&nbsp;&nbsp;<button id=update onclick="update()">정보수정</button>
                    </div>
                      <hr>
                    <div class="col-md-8">  
                    <ul class=" details">
                      ...
                      <li><p><span class="glyphicon glyphicon-map-marker one" style="width:50px;"></span>${requestScope.student.member_id}</p></li>
                      <li><p><span class="glyphicon glyphicon-credit-card one" style="width:50px;"></span>${requestScope.student.gender}</p></li>
                    </ul>
                    </div>
                    <div class="col-md-4">  
                      ...
                      <div class="col-sm-5 col-xs-6 tital " >Gender:</div><div class="col-sm-7 col-xs-6 ">${requestScope.student.gender}</div>
                      <div class="clearfix"></div><div class="bot-border"></div>
      ...
      <button id="studentinfo">여기 버튼</button>
      <div id=show></div>
      <script>
      window.onload=mainLoad();
      
      function update(){
		  location.href="${ctx}/member.do?action=move&page=update&member_id=${requestScope.student.member_id}";
	}
